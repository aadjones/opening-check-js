...
const Settings: React.FC = () => {
  ...
  return (
    <div className={styles.settings}>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>🛠️ Debug Tools</h2>
        </div>
        <div className={styles.sectionContent}>
          <DebugSection />
        </div>
...
const DebugSection: React.FC = () => {
  ...
  console.log('DebugSection rendering, user:', session?.user?.id);
  ...
  return (
    <>
      <div className={styles.formGroup}>
        <label className={styles.label}>Review Queue</label>
        <div className={styles.helpText} style={{ marginBottom: '1rem' }}>
          Reset your spaced repetition review queue to make all puzzles available for review again. 
        ...
        {resetMessage && (
          <div className={`${styles.syncMessage} ${styles[resetMessage.type]}`}>
            {resetMessage.text}
          </div>
        )}
      </div>
