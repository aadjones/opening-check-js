...
def check_directories():
    ...
    if not (Path("chess_backend").exists() and Path("chess_frontend").exists()):
    ...
    # Check backend setup
    if not Path("chess_backend/env").exists():
    ...
    if not Path("chess_frontend/node_modules").exists():
