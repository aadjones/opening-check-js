...
from chess_utils import find_deviation
...
def test_user_deviates_first_white():
...
def test_user_deviates_first_black():
...
def test_opponent_deviates_first_white():
